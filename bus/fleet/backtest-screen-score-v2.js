...
const EQUITY_UNIVERSE_PATH = avPaths.fleetData('fleet-universe.json');
const CRYPTO_UNIVERSE_PATH = avPaths.fleetData('crypto-universe.json');
const REPORT_PATH = avPaths.fleetData('backtest-screen-score-v2-results.md');
