...
function upsertWatchlistRow(watchlistPath, header, symbol, name, category, notePath, isCrypto) {
  ...
  if (!fs.existsSync(watchlistPath)) {
    content = [
      ...
      'company-research layer (`bus/fleet/vault-research-writer.js`) --',
...
function publishCompanyResearch(pilot, symbol, researchTaskId) {
  ...
  const noteBody = [
    ...
    '## Provenance',
    '',
    `Company/asset research: \`${researchTaskId}\` (Codex, real hosted web-search tool, \`to: codex\`). Generated by \`bus/fleet/generate-pilot-tasks.js\`'s \`generateCompanyResearchTask()\`, published into the vault by \`bus/fleet/vault-research-writer.js\` on ${asOf}. Part of the layered research pipeline added 2026-09-13.`,
