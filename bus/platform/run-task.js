...
// 'antigravity': confirmed live 2026-09-23 (view_file of a vault file succeeded under its read_file allow rule).
const LIVE_FILE_READ_CAPABLE = new Set(['claude-agent', 'codex', 'antigravity']);
...
// 'antigravity': confirmed live 2026-09-23 (search_web ran and returned a sourced answer).
const WEB_SEARCH_CAPABLE = new Set(['claude-agent', 'codex', 'antigravity']);
...
const DISPATCHED_SPECIALISTS = new Set(['codex', 'claude-agent', 'antigravity']);
