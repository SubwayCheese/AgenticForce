...
// chosen ONCE per pilot and persisted (bus/scripts/backtest-search-split-state.json).
...
const WEIGHTS_PATH = path.join(__dirname, 'screen-score-weights.json');
const SPLIT_STATE_PATH = path.join(__dirname, 'backtest-search-split-state.json');
