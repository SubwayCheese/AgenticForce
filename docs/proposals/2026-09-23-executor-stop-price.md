...
**Status: APPLIED 2026-09-23 (owner delegated all decisions; tests moved to `bus/tests/survive/stop-price.test.js`, suite 119/119).** Patch written, tested on a scratch copy (36/36), cross-reviewed by codex in three rounds (each round reproduced real flaws and the patch was reworked;
